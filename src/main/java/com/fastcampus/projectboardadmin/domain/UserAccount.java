...
public class UserAccount extends AuditingFields {
    ...
    private UserAccount(String userId, String userPassword, Set<RoleType> roleTypes, String email,
        String nickname,
    ...
    public static UserAccount of(String userId, String userPassword, Set<RoleType> roleTypes,
